...
namespace BL.SchemaModel
{
    public class AddSuplier
    {
        ...
        [GSchema("cpname", "Enter Contact Person Name", "string", false, getHtmlClass = "col-md-6")]
        public string cpname { get; set; }
        
        [GSchema("email", "Enter Email", "email", false, getHtmlClass = "col-md-6")]
        public string email { get; set; }
        [GSchema("cphone", "Enter Phone", "string", false, getHtmlClass = "col-md-6")]
        public string cphone { get; set; }
        [GSchema("address", "Enter Address", "string", true, getHtmlClass = "col-md-6")]
        public string address { get; set; }
        [GSchema("pan", "Enter PAN", "string", false, getRegularExpression = "[A-Z]{5}[0-9]{4}[A-Z]{1}", getmessage = true, getHtmlClass = "col-md-6")]
